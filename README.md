...
- [FRAMEWORK_GUIDE.md](./Microweb/FRAMEWORK_GUIDE.md) — Complete framework guide with examples
- [RESUMEN_IMPLEMENTACION.md](./RESUMEN_IMPLEMENTACION.md) — Spanish implementation summary (detalle técnico completo)